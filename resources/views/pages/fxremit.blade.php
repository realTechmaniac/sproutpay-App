                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Fx-Remit</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="needs-validation" method="POST" action="{{url('/storeremit')}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-5">
                                                    <div class="form-group">
                                                        <label for="validationCustom01">Send Currency</label>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="validationCustom02"><strong>Amount to Pay</strong></label>
