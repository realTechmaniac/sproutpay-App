                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">MoneyTransfer</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="needs-validation" method="POST" action="{{url('/storemoneytransfer')}}">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="validationCustom01">Sender Currency</label>
                                                        <select class="form-control" id="myselect" name="sendercurrency" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="validationCustom02">Amount to Send</label>
                                                        <input type="number" class="form-control" id="amount_to_send" placeholder="Amount to send"  name="amount" value="{{old('amount')}}" required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-5">
                                                    <div class="form-group">
                                                        <label for="validationCustom01">Recipient Currency</label>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="validationCustom02"><strong>Recipient receives</strong></label>
                                                       <h5><strong<span id="total_amount_to_recieve"></span></strong>
                                                        </h5>
                                                    </div>
                                                </div>
