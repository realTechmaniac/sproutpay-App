...
class FxremitTransactionsController extends Controller
{
    public function index(){

    	return view('pages.fxremit');
    }
    ...
    $fxremitTransaction  = fxremitTransaction::create([
    ...
    return $fxremitTransaction;


    	Mail::send(new TransactionSuccessful($fxremitTransaction));
